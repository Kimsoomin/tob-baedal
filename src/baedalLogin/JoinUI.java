...
public class JoinUI extends JFrame implements ActionListener {
	...
	public JoinUI() {
		...
		/*
		 * jp.setBackground(Color.WHITE); jp1.setBackground(Color.WHITE);
		 * jp2.setBackground(Color.WHITE); jpId.setBackground(Color.WHITE);
		 * jpIde.setBackground(Color.WHITE); jpPw.setBackground(Color.WHITE);
		 * jpName.setBackground(Color.WHITE);
		 * jpBirth.setBackground(Color.WHITE);
		 * jpAddr.setBackground(Color.WHITE); jpHp.setBackground(Color.WHITE);
		 * jpQue.setBackground(Color.WHITE); jpAn.setBackground(Color.WHITE);
		 * jpJo.setBackground(Color.WHITE); jpCn.setBackground(Color.WHITE);
		 */
